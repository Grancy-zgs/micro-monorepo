...
import { createRouter, createWebHistory, createWebHashHistory, RouterHistory, Router } from 'vue-router'
...
function handleMicroData(router: Router) {
	// eventCenterForAppNameVite 是基座添加到window的数据通信对象 1.0版本后不需要了(已删除)
